package com.prolificwebworks.theclubix.cpicker;
...
public class CollectionPicker extends LinearLayout {
    ...
    private List<com.prolificwebworks.theclubix.cpicker.Item> mItems = new ArrayList<>();
    private LinearLayout mRow;
    private HashMap<String, Object> mCheckedItems = new HashMap<>();
    private com.prolificwebworks.theclubix.cpicker.OnItemClickListener mClickListener;
    private int mWidth;
    ...
    private int mLayoutBackgroundColorNormal = getResources().getColor(android.R.color.transparent);
    private int mLayoutBackgroundColorPressed = getResources().getColor(R.color.colorAccent1);
    ...
    public CollectionPicker(Context context, AttributeSet attrs, int defStyle) {
        ...
        this.mItemMargin = (int) typeArray
                .getDimension(R.styleable.CollectionPicker_cp_itemMargin,
                        com.prolificwebworks.theclubix.cpicker.Utils.dpToPx(this.getContext(), mItemMargin));
    ...
    public void drawItemView() {
        ...
        for (int i = 0; i < mItems.size(); i++) {
            ...
            if (!simplifiedTags) {
                itemLayout.setOnClickListener(new OnClickListener() {
                    ...
                    public void onClick(View v) {
                        ...
                        ImageView iconView = (ImageView) itemLayout.findViewById(R.id.firstTimeChecker);
            ...
            TextView itemTextView = (TextView) itemLayout.findViewById(R.id.firstTimeText);
...
//            itemTextView.setTextColor(getResources().getColor(mTextColor));
            ...
            // if (!simplifiedTags) {
            ImageView indicatorView = (ImageView) itemLayout.findViewById(R.id.firstTimeChecker);
    ...
    private View createItemView(Item item) {
        View view = mInflater.inflate(R.layout.item_first_timer, this, false);
        if (isJellyBeanAndAbove()) {
